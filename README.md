...
To get started with Custom Proxy domain feature, refer to our [installation guide](/docs/CustomDomainSetup.md) for instructions on installing and using our iOS SDK in your project.
