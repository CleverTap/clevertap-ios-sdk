...
s.ios.exclude_files         = 'CleverTapSDK/include/**/*.h', 'CleverTapSDK/**/*~tvOS.xib'
...
s.tvos.exclude_files        = 'CleverTapSDK/include/**/*.h', 'CleverTapSDK/CleverTapJSInterface.{h,m}', 'CleverTapSDK/CTContentFetchManager.{h,m}', 'CleverTapSDK/InApps/CustomTemplates/**/*', 'CleverTapSDK/InApps/HTMLController/**/*'
s.tvos.public_header_files  = 'CleverTapSDK/CleverTap.h', 'CleverTapSDK/CleverTap+SSLPinning.h', 'CleverTapSDK/CleverTapInstanceConfig.h', 'CleverTapSDK/CleverTapBuildInfo.h', 'CleverTapSDK/CleverTapEventDetail.h', 'CleverTapSDK/CleverTapSyncDelegate.h', 'CleverTapSDK/CleverTapTrackedViewController.h', 'CleverTapSDK/CleverTapUTMDetail.h', 'CleverTapSDK/CleverTap+FeatureFlags.h', 'CleverTapSDK/CleverTap+ProductConfig.h', 'CleverTapSDK/CleverTap+InAppNotifications.h', 'CleverTapSDK/CleverTap+CTVar.h', 'CleverTapSDK/ProductExperiences/CTVar.h', 'CleverTapSDK/InApps/InAppsScheduler/*.h', 'CleverTapSDK/InApps/CTInAppStore.h', 'CleverTapSDK/CTSwitchUserDelegate.h', 'CleverTapSDK/CleverTapInAppNotificationDelegate.h'
end
