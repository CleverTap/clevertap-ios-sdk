...
s.ios.resource_bundles      = {'CleverTapSDK' => ['CleverTapSDK/**/*.{png,html}', 'CleverTapSDK/**/*.{xcprivacy}', 'CleverTapSDK/**/*.xcdatamodeld', 'CleverTapSDK/**/*~land.xib', 'CleverTapSDK/**/*~port.xib', 'CleverTapSDK/**/*~ipad.xib', 'CleverTapSDK/**/*~ipadland.xib', 'CleverTapSDK/**/*~iphoneland.xib', 'CleverTapSDK/**/*~iphoneport.xib', 'CleverTapSDK/**/CTCarouselImageView.xib', 'CleverTapSDK/**/CleverTapInboxViewController.xib']}
s.ios.deployment_target     = '9.0'
s.ios.source_files          = 'CleverTapSDK/**/*.{h,m,swift}'
s.ios.exclude_files         = 'CleverTapSDK/include/**/*.h', 'CleverTapSDK/**/*~tv.xib'
...
s.tvos.dependency            'SDWebImage', '~> 5.11'
s.tvos.resource_bundles     = {'CleverTapSDK' => ['CleverTapSDK/**/*~tv.xib', 'CleverTapSDK/**/*.{png,html}', 'CleverTapSDK/**/*.{xcprivacy}', 'CleverTapSDK/**/*.xcdatamodeld']}
