...
@implementation NSObject (CTSwizzle)
...
+ (BOOL)ct_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError**)error_ {
    return [GetClass((id)self) ct_swizzleMethod:origSel_ withMethod:altSel_ error:error_];
}
...
+ (NSInvocation*)ct_swizzleMethod:(SEL)origSel withBlock:(id)block error:(NSError**)error {
    ...
    [self ct_swizzleMethod:origSel withMethod:blockSel error:nil];
    
    return origInvocation;
}

+ (NSInvocation*)ct_swizzleClassMethod:(SEL)origSel withBlock:(id)block error:(NSError**)error {
    NSInvocation *invocation = [GetClass((id)self) ct_swizzleMethod:origSel withBlock:block error:error];
