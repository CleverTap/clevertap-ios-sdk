...
#define CLTAP_FILE_ACTIVE_DICT @"files_active_dict"
#define CLTAP_FILE_INACTIVE_DICT @"files_inactive_dict"
#define CLTAP_FILE_ASSETS_LAST_DELETED_TS @"files_last_deleted_timestamp"
