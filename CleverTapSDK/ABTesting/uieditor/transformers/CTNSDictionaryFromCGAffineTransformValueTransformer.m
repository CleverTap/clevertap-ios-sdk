...
@implementation CTNSDictionaryFromCGAffineTransformValueTransformer
...
- (id)transformedValue:(id)value {
    if ([value respondsToSelector:@selector(CGAffineTransformValue)]) {
        return CTCGAffineTransformCreateDictionaryRepresentation([value CGAffineTransformValue]);
    }
    return @{};
}
...
- (id)reverseTransformedValue:(id)value {
    ...
    if ([value isKindOfClass:[NSDictionary class]] && CTCGAffineTransformMakeWithDictionaryRepresentation(value, &transform)) {
