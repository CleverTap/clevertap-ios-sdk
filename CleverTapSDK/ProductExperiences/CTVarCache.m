...
//        [archiver encodeBool:[LPConstantsState sharedState].loggingEnabled forKey:LP_KEY_LOGGING_ENABLED];
        [archiver encodeObject:self.varsJson forKey:CLEVERTAP_DEFAULTS_VARS_JSON_KEY];
...
// TODO: commented sendVariablesIfChanged, sendActionsIfChanged, sendContentIfChanged and maybeUploadNewFiles. ask if these are needed
