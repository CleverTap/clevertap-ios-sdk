...
struct MyCustomDomainViewController: UIViewControllerRepresentable {
    typealias UIViewControllerType = CustomDomainViewController
    func makeUIViewController(context: Context) -> CustomDomainViewController {
        let vc = CustomDomainViewController()
