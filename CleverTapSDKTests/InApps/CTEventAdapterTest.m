...
- (void)testPropertyValueNamed {
    ...
    // " prop  1" normalizes to "prop1", which matches all three keys — any of their values is valid
    NSArray *possibleValues = @[value, @"value1", @"value2"];
    XCTAssertTrue([possibleValues containsObject:[[eventAdapter propertyValueNamed:@" prop  1"] stringValue]]);
    ...
    eventAdapter = [self eventAdapterWithProperties:eventProperties];
    // "prop1" normalizes to "prop1", which matches all three keys — any of their values is valid
    NSArray *possibleValues2 = @[@"value1", @"value2", @"value3"];
    XCTAssertTrue([possibleValues2 containsObject:[[eventAdapter propertyValueNamed:@"prop1"] stringValue]]);
}
