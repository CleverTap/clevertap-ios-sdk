...
- (void)testDidShow {
    ...
    CTInAppNotification *notif = [[CTInAppNotification alloc] initWithJSON:inApp fileDownloader:self.fileDownloader];
...
- (void)testRemoveStaleInAppCountsRemovesTriggersAndImpressions {
    ...
    CTInAppNotification *notif = [[CTInAppNotification alloc] initWithJSON:inApp fileDownloader:self.helper.fileDownloader];
...
- (void)testSessionCapacityMaxedOutInApp {
    ...
    notif = [[CTInAppNotification alloc] initWithJSON:inAppMdc1000 fileDownloader:self.fileDownloader];
    XCTAssertEqual(1, notif.maxPerSession);
    ...
    notif = [[CTInAppNotification alloc] initWithJSON:inAppMdc3 fileDownloader:self.fileDownloader];
...
- (void)testSessionCapacityMaxedOutInAppLegacy {
    ...
    CTInAppNotification *notif = [[CTInAppNotification alloc] initWithJSON:inAppMdc3 fileDownloader:self.fileDownloader];
    XCTAssertEqual(3, notif.maxPerSession);
    self.inAppFCManager.impressionManager.sessionImpressions = [@{
        @"1": @2
    } mutableCopy];
