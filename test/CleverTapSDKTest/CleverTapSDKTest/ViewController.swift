...
class ViewController: UIViewController, CleverTapInboxViewControllerDelegate, WKNavigationDelegate, WKScriptMessageHandler, UIScrollViewDelegate, CleverTapDisplayUnitDelegate {
...
//        NotificationCenter.default.post(Notification(name: UIApplication.didFinishLaunchingNotification))
...
//        
    ...
    func profilePush() {
        let profile: Dictionary<String, AnyObject> = [
            "Email": "sonalkachare@clevertap.com" as AnyObject,
...
//        CleverTap.sharedInstance()?.recordEvent("Button Pressed")
        CleverTap.sharedInstance()?.productConfig.get("appColor")
