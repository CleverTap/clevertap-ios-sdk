...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate, CleverTapInAppNotificationDelegate, CleverTapSyncDelegate, CleverTapFeatureFlagsDelegate, CleverTapProductConfigDelegate, CleverTapPushNotificationDelegate {
...
//        CleverTap.sharedInstance()?.enableDeviceNetworkInfoReporting(true)
        ...
        CleverTap.setDebugLevel(CleverTapLogLevel.off.rawValue + 4)
